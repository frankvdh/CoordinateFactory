...
The 
problem I'm trying to solve is that I have a subclass of _Coordinate_ which has additional methods. However, when the JTS library performs _union()_, _difference()_, etc operations on _LineStrings_ or _Polygons_ made up of my _Coordinates_,
